...
describe('Service Tests', () => {
    ...
    describe('LieuMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LieuMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/lieus';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LieuMySuffix', () => {

                let entity: LieuMySuffix;
                service.find(123).subscribe((_entity: LieuMySuffix) => {
                    entity = _entity;
                });
