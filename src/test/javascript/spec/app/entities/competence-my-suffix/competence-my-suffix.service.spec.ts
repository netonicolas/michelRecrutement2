...
describe('Service Tests', () => {
    ...
    describe('CompetenceMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CompetenceMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/competences';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CompetenceMySuffix', () => {

                let entity: CompetenceMySuffix;
                service.find(123).subscribe((_entity: CompetenceMySuffix) => {
                    entity = _entity;
                });
