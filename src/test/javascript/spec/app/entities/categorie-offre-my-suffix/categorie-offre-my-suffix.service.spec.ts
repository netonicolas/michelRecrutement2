...
describe('Service Tests', () => {
    ...
    describe('CategorieOffreMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CategorieOffreMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/categorie-offres';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CategorieOffreMySuffix', () => {

                let entity: CategorieOffreMySuffix;
                service.find(123).subscribe((_entity: CategorieOffreMySuffix) => {
                    entity = _entity;
                });
