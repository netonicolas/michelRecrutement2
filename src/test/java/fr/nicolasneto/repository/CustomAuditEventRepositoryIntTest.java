...
import fr.nicolasneto.config.audit.AuditEventConverter;
import fr.nicolasneto.domain.PersistentAuditEvent;
...
import static fr.nicolasneto.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
